...
def train(dataset_path, train_conf, model_path, add_timestamp):
    ...
    train_history = model.fit_generator(dataset.get_train_sequence(), epochs=train_conf['epochs'],
                                        validation_data=dataset.get_test_sequence(), verbose=train_conf['verbose'])
